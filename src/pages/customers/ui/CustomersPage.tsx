...
export function CustomersPage() {
  ...
  const { data: customers = [], isLoading: isLoadingCustomers } = useCustomers(merchantId);
        ...
        <div className="rounded-lg bg-white shadow-sm">
          ...
          {isLoadingCustomers ? (
            ...
            <div className="flex flex-col items-center gap-2 py-16 text-center">
              ...
              <p className="font-medium text-brown/40">
                {search ? 'Aucun client trouvé' : 'Aucun client pour le moment'}
              </p>
              {!search && (
                <p className="text-sm text-brown/30">
                  ...
                  <li key={customer.id}>
                    ...
                    >
                      ...
                      <div className="flex items-center">
                        <span className="truncate text-sm text-brown/60">
                          {customer.email ?? <span className="italic text-brown/30">—</span>}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        <span className="text-sm text-brown/60">
                          {formatLastVisit(stats?.last_visit ?? null)}
                        </span>
                      </div>
                    </Link>
                  </li>
