...
import { useUpdateProgram } from '../model/useUpdateProgram';
...
export function EditProgramModal({ program, merchantId, onClose }: EditProgramModalProps) {
  const { updateProgramAsync, isPending, error } = useUpdateProgram();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-brown/10 px-6 py-4">
          <h2 className="text-lg font-semibold text-brown">Modifier le programme</h2>
          <button
            onClick={onClose}
